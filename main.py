...
class Controller(object):
    ...
    def train(self, data):
        ...
        for i in range(args.epochs):
            ...
            loss = L_cls + (args.w_f * sp_loss) + (args.w_b * b) + (args.w_film * film) 
            loss.backward()
            self.optim.step()
        return
    ...
    def test(self, data):
        ...
        preds = output.cpu()[data.idx_test].max(1)[1]
...
def main():
    ...
    for i in range(num):
        ...
        acc, out1, out2 = controller.test(data)
